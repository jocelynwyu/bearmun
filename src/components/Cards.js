      ...
      <ul className="cards__items">
        <div className="rows">
          ...
          <CardItem
            ...
            bio="Anna Lieggi (she/hers) is a sophomore studying Global Studies and Political Science at Berkeley. She is pre-law with the hopes of taking a gap year to travel and study! In her free time she likes to hike, go to the beach, and read. Some of her favorite artists include Lana Del Rey, Odesza, and The Cranberries. She joined UCBMUN her first semester at Berkeley and enjoyed staffing the BearMun and UCBMUN conferences last year! This year she is so excited to be helping coordinate BearMun and help make this a great experience for you!"
          />
        </div>
        <div className="rows">
          <CardItem
        ...
        <div className="rows">
          ...
          <CardItem
            ...
            bio="Amara Fernandes is a second-year Political Economy major with minors in Philosophy and Public Policy. As a Bay Area native and high school speech and debate kid, she joined UC Berkeley Model United Nations in Spring '24 to join a tight-knit group of like-minded individuals as well as further her love of competition. She has been passionate about politics and community engagement since middle school, and MUN is just one extension of that. Outside of MUN, she likes to read, bake, and play geography games on Sporcle. She's excited to be on Secretariat this year and can't wait for the conference!"
          />
        </div>
        <div className="rows">
          <CardItem
