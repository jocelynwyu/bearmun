...
function CommitteePage2(props) {
  return (
    <div className="committees__item__inner">
      ...
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description1}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description2}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description3}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description4}</div>
      <br/>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description5}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description6}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description7}</div>
      <div className="description" style={{textAlign:"center", fontStyle:"italic"}}>{props.description8}</div>
